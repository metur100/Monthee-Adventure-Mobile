...
{
    public class GreenBulletPrefab : MonoBehaviour
    {
        public Rigidbody2D rb;
        public int damageDoneGreenBullet = -300; //it deals 40 damage close range, 20 damage long range
        private readonly float speedOfMeleeAttack = 300f;
