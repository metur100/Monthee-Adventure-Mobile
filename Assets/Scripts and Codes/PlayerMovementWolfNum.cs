...
public class PlayerMovementWolfNum : MonoBehaviour
{
    ...
    public void CoroutineWolfSlowOverTimeFrost()
    {
        StartCoroutine(SlowOverTimeOnHitWithFrostBullet());
    }
    public void CoroutineMoveIfTrapWolf()
    {
        StartCoroutine(stopMoveIfTrapWolf());
    }
    ...
    IEnumerator stopMoveIfTrapWolf()
    {
