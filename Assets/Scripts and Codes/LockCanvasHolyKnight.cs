...
public class LockCanvasHolyKnight : MonoBehaviour
{
    private float posXMinus = 163;
    private float posXPlus = 163;
    private float posYMinus = 92;
    private float posYPlus = 92;
    Transform t;
